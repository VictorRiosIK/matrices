    ...
    public static void main(String[] args) {
        ...
        switch (opcion) {
            case 1:
                ...
                int serverPort = 50001; // Puerto del servidor
                int numThreads = 2; // Número de hilos de cliente
                Thread[] threads = new Thread[numThreads];
                 int N = 6; // Número de renglones de la matriz
                int M = 5; // Número de columnas de la matriz
                ...
                try{ 
                   threads[0] = new MatrixClient(serverAddress, serverPort, submatricesA_grupo1,transposedMatrixB,2);
                   threads[1] = new MatrixClient(serverAddress, 50002, submatricesA_grupo2,transposedMatrixB,3);
